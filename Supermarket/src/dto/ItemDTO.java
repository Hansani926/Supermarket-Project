...
public class ItemDTO {
    ...
    public ItemDTO(String productID, String productName, String description, String specification, String displayName, Boolean avaliability, Boolean activeState, String availableBrand) {
        ProductID = productID;
